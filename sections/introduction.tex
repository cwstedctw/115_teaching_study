...
本校通識教育中心開設之「程式設計與應用」課程，以Python為教學語言\cite{cs50p2024}，
...
ChatGPT、GitHub Copilot等生成式AI工具能夠快速生成完整程式碼\cite{finnieansley2022robots,denny2023conversing}，
...
且在後續獨立解題時表現顯著下降\cite{finnieansley2023exam}。
