...
\subsubsection{第一階段：引導期（第1-6週）——Python基礎與AI學習策略}
...
\subsubsection{第二階段：轉換期（第7-12週）——進階知識與問題解決}
...
\subsubsection{第三階段：自主期（第13-18週）——專題實作與自主學習}
...
\subsubsection{PBL任務一覽}

\begin{longtable}{|c|m{3.2cm}|m{5cm}|m{4cm}|}
\hline
